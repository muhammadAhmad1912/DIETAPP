...
export const Icons = {
  ...
  planner: 'clipboard' as AppIconName,
  grocery: 'cart' as AppIconName,
  checkOutline: 'ellipse-outline' as AppIconName,
  dashboard: 'home' as AppIconName,
  history: 'calendar' as AppIconName,
  progress: 'stats-chart' as AppIconName,
  streak: 'flame' as AppIconName,
  consistency: 'trophy' as AppIconName,
  analytics: 'pulse' as AppIconName,
  weight: 'fitness' as AppIconName,
  inventory: 'cube' as AppIconName,
  more: 'ellipsis-horizontal' as AppIconName,
  settings: 'settings-outline' as AppIconName,
  chevron: 'chevron-forward' as AppIconName,
  add: 'add' as AppIconName,
  scan: 'barcode' as AppIconName,
  search: 'search' as AppIconName,
  suggest: 'sparkles' as AppIconName,
